...
class coders(models.Model):
    ...
    workType = models.CharField(validators=[int_list_validator], max_length=100, null=True, default=None)
    position = models.CharField(max_length=50, null=True, default=None)
    industryType = models.CharField(validators=[int_list_validator], max_length=100, null=True, default=None)
    skillType = models.CharField(validators=[int_list_validator], max_length=100, null=True, default=None)
